...
/** SAI NPU LAG - Set LAG Port Mode
  \param[in] lag_id LAG Identifier
  \param[in] port_id Port Identifier
  \param[in] mode SAI LAG Port forwarding mode
  \return Success: SAI_STATUS_SUCCESS
Failure: Appropriate error code on failure
 */
typedef sai_status_t (*sai_npu_lag_port_mode_set_fn)(sai_object_id_t lag_id,
                                                     sai_object_id_t port_id,
                                                     sai_lag_port_mode_t mode);

/** SAI NPU LAG - Get LAG Port Mode
  \param[in] lag_id LAG Identifier
  \param[in] port_id Port Identifier
  \param[out] mode SAI LAG Port forwarding mode
  \return Success: SAI_STATUS_SUCCESS
Failure: Appropriate error code on failure
 */
typedef sai_status_t (*sai_npu_lag_port_mode_get_fn)(sai_object_id_t lag_id,
                                                     sai_object_id_t port_id,
                                                     sai_lag_port_mode_t *mode);
...
typedef struct _sai_npu_lag_api_t {
    ...
    sai_npu_lag_port_mode_set_fn       lag_port_mode_set;
    sai_npu_lag_port_mode_get_fn       lag_port_mode_get;
