...
#define SAI_DFLT_LOOPBACK_MODE          SAI_PORT_INTERNAL_LOOPBACK_NONE
#define SAI_DFLT_FDB_LEARNING_MODE      SAI_PORT_LEARN_MODE_HW
...
#define SAI_DFLT_FLOW_CONTROL_MODE      SAI_PORT_FLOW_CONTROL_DISABLE
