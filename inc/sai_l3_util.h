...
#define SAI_ROUTER_LOG_TRACE(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_ROUTER_LOG_CRIT(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_ROUTER_LOG_ERR(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_ROUTER_LOG_INFO(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_ROUTER_LOG_WARN(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_ROUTER_LOG_NTC(msg, ...) \
        SAI_ROUTER_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI Router Interface API */
#define SAI_RIF_LOG_TRACE(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_RIF_LOG_CRIT(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_RIF_LOG_ERR(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_RIF_LOG_INFO(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_RIF_LOG_WARN(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_RIF_LOG_NTC(msg, ...) \
        SAI_RIF_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI Neighbor API */
#define SAI_NEIGHBOR_LOG_TRACE(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_NEIGHBOR_LOG_CRIT(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_NEIGHBOR_LOG_ERR(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_NEIGHBOR_LOG_INFO(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_NEIGHBOR_LOG_WARN(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_NEIGHBOR_LOG_NTC(msg, ...) \
        SAI_NEIGHBOR_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI NextHop API */
#define SAI_NEXTHOP_LOG_TRACE(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_NEXTHOP_LOG_CRIT(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_NEXTHOP_LOG_ERR(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_NEXTHOP_LOG_INFO(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_NEXTHOP_LOG_WARN(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_NEXTHOP_LOG_NTC(msg, ...) \
        SAI_NEXTHOP_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI NextHopGroup API */
#define SAI_NH_GROUP_LOG_TRACE(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_NH_GROUP_LOG_CRIT(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_NH_GROUP_LOG_ERR(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_NH_GROUP_LOG_INFO(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_NH_GROUP_LOG_WARN(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_NH_GROUP_LOG_NTC(msg, ...) \
        SAI_NH_GROUP_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI Route API */
#define SAI_ROUTE_LOG_TRACE(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_ROUTE_LOG_CRIT(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_ROUTE_LOG_ERR(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_ROUTE_LOG_INFO(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_ROUTE_LOG_WARN(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_ROUTE_LOG_NTC(msg, ...) \
        SAI_ROUTE_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)
 ...
 */
sai_fib_nh_t* sai_fib_ip_next_hop_node_get (sai_object_id_t vrf_id,
