...
{
    return (sai_uoid_obj_type_get (uoid) == SAI_OBJECT_TYPE_MIRROR);
}
...
{
    return (sai_uoid_obj_type_get (uoid) == SAI_OBJECT_TYPE_STP_INSTANCE);
}
...
{
    return (sai_uoid_obj_type_get (uoid) == SAI_OBJECT_TYPE_TRAP_GROUP);
}
...
{
    return (sai_uoid_obj_type_get (uoid) == SAI_OBJECT_TYPE_QOS_MAPS);
}
