...
#define SAI_SCHED_LOG_TRACE(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_SCHED_LOG_CRIT(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_SCHED_LOG_ERR(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_SCHED_LOG_INFO(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_SCHED_LOG_WARN(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_SCHED_LOG_NTC(msg, ...) \
        SAI_SCHED_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI Scheduler group API */
#define SAI_SCHED_GRP_LOG_TRACE(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_SCHED_GRP_LOG_CRIT(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_SCHED_GRP_LOG_ERR(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_SCHED_GRP_LOG_INFO(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_SCHED_GRP_LOG_WARN(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_SCHED_GRP_LOG_NTC(msg, ...) \
        SAI_SCHED_GRP_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI Queue API */
#define SAI_QUEUE_LOG_TRACE(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_QUEUE_LOG_CRIT(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_QUEUE_LOG_ERR(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_QUEUE_LOG_INFO(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_QUEUE_LOG_WARN(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_QUEUE_LOG_NTC(msg, ...) \
        SAI_QUEUE_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI POLICER API */
#define SAI_POLICER_LOG_TRACE(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_POLICER_LOG_CRIT(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_POLICER_LOG_ERR(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_POLICER_LOG_INFO(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_POLICER_LOG_WARN(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_POLICER_LOG_NTC(msg, ...) \
        SAI_POLICER_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI WRED API */
#define SAI_WRED_LOG_TRACE(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_WRED_LOG_CRIT(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_WRED_LOG_ERR(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_WRED_LOG_INFO(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_WRED_LOG_WARN(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_WRED_LOG_NTC(msg, ...) \
        SAI_WRED_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)


/** Per log level based macros for SAI QOS MAPS API */
#define SAI_MAPS_LOG_TRACE(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_MAPS_LOG_CRIT(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_MAPS_LOG_ERR(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_MAPS_LOG_INFO(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_MAPS_LOG_WARN(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_MAPS_LOG_NTC(msg, ...) \
        SAI_MAPS_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)

/** Per log level based macros for SAI QOS INIT API */
#define SAI_QOS_LOG_TRACE(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_DEBUG, msg, ##__VA_ARGS__)

#define SAI_QOS_LOG_CRIT(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_CRITICAL, msg, ##__VA_ARGS__)

#define SAI_QOS_LOG_ERR(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_ERROR, msg, ##__VA_ARGS__)

#define SAI_QOS_LOG_INFO(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_INFO, msg, ##__VA_ARGS__)

#define SAI_QOS_LOG_WARN(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_WARN, msg, ##__VA_ARGS__)

#define SAI_QOS_LOG_NTC(msg, ...) \
        SAI_QOS_LOG (SAI_LOG_NOTICE, msg, ##__VA_ARGS__)
